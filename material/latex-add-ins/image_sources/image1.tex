\begin{tikzpicture}[scale=0.3]
	...
	\draw ($ (tm0) + (-20,-20) $) rectangle ++(40,40);
	\draw ($ (tm0) + (-30,-20) $) -- ++(0, 40) -- ++(-20, -10) -- ++(0, -20) --cycle;
	\draw ($ (tm0) + (-20,10) $) -- ++(-10, 00);
	\draw ($ (tm0) + (-20,-10) $) -- ++(-10, 00);
	\node[text width=40, align=center] at ($ (tm0) + (0,-40) $) {\textbf{=}};
	\draw ($ (tm0) + (-20,-50) $) rectangle ++(40,20);
	\draw[->, >=latex', ultra thick] ($ (tm0) + (0,-20) $) to                       ++(0,-10);
