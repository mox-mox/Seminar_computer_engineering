\begin{tikzpicture}[scale=0.3]
	\draw[thick] (-70,0) -- ++(70,0) -- ++(0, 220) -- ++(-70,0);
	\node[font=\normalsize] at (-10, -10) {\textbf{ExampleRocketTop}};
	...
	%\draw[<->, ultra thick] ( 0,  65)   -- node[above=-2pt, font=\small] {io\_l2\_axi4\_0}            ++(100,0);
	\draw[<->, ultra thick] ( 0,  45)   -- node[above=-2pt, font=\small] {io\_mem\_axi4\_0}           ++(100,0);
	\draw[<->, ultra thick] ( 0,  25)   -- node[above=-2pt, font=\small] {io\_mio\_axi4\_0}           ++(100,0);

	\draw[<->, ultra thick] ( 0,  45)   -- node[above=-2pt, font=\small] {TileLink}                   ++(-50,0);
	\draw[<->, ultra thick] ( 0,  25)   -- node[above=-2pt, font=\small] {TileLink}                   ++(-50,0);
\end{tikzpicture}
