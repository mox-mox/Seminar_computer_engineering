\begin{tikzpicture}[scale=0.3]
	...
	\draw[->, >=latex', shorten >=2pt, shorten <=2pt, thick, dashed] (mem.east) -- ++(200,0);
	\draw[->, >=latex', shorten >=2pt, shorten <=2pt, thick, dashed] (man.east) -- ++(200,0);
	\draw[->, >=latex', shorten >=2pt, shorten <=2pt, thick, dashed] (cla.east) -- ++(200,0);
	\draw[->, >=latex', shorten >=2pt, shorten <=2pt, thick, dashed] (clb.east) -- ++(200,0);
	\draw[->, >=latex', shorten >=2pt, shorten <=2pt, thick, dashed] (clc.east) -- ++(200,0);
