...
Rocket and Boom are open source implementations of RISC-V processor cores developed at the university of Berkely, as is RocketChip, a framework written in Chisel that can create processors using Rocket-, Boom- or custom cores.
